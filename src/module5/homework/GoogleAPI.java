...
public class GoogleAPI implements API{
    ...
    public GoogleAPI() {
        rooms = new Room[5];
        rooms[0] = new Room(223,1000,1, new Date(2016-9-1),"Khreshchatyk", "Kyiv");
        rooms[1] = new Room(224,1000,1, new Date (2016-9-1),"Premier palace", "Dnipro");
        rooms[2] = new Room(225,1000,1, new Date (2016-9-1),"Alfavito", "Zhytomyr");
        rooms[3] = new Room(226,1000,1, new Date (2016-9-1),"Radisson", "Lviv");
        rooms[4] = new Room(227,1000,1, new Date (2016-9-1),"Ukraine", "Odessa");
    }
